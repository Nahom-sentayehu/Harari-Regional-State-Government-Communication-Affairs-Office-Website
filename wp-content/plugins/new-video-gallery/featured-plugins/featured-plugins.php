...
wp_enqueue_style( 'awl-bootstrap-css', VG_PLUGIN_URL . 'css/bootstrap.css' );
wp_enqueue_script( 'awl-bootstrap-js', VG_PLUGIN_URL . 'js/bootstrap.js', array( 'jquery' ), '', true );
wp_enqueue_style( 'thickbox' );
wp_enqueue_style( 'fp-bootstrap-css', VG_PLUGIN_URL . 'featured-plugins/css/bootstrap.css' );
wp_enqueue_style( 'fp-smartech-css', VG_PLUGIN_URL . 'featured-plugins/css/smartech.css' );
wp_enqueue_style( 'fp-feature-plugins', VG_PLUGIN_URL . 'featured-plugins/css/feature-plugins.css' );
wp_enqueue_script( 'jquery' );
wp_enqueue_script( 'fp-media-uploads', VG_PLUGIN_URL . 'js/featured-plugins/acl-media-upload-script.js', array( 'media-upload', 'thickbox', 'jquery' ) );
wp_enqueue_script( 'fp-bootstrap-min-js', VG_PLUGIN_URL . 'js/featured-plugins/bootstrap.min.js' );
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12 text-center custom-buy-button">
											<a href="https://awplife.com/premium-wordpress-plugins/" target="_blank" class="btn btn-info btn-circle btn-xl"><i class="glyphicon glyphicon-shopping-cart"></i> Buy Now</a>
										</div>
									</div>
									<hr>
								</div>
