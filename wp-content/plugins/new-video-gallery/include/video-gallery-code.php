...
while ( $loop->have_posts() ) :
	...
	?>
	<div id="image_gallery_<?php echo esc_html( $video_gallery_id ); ?>" class="row all-images">
		<?php
			...
			foreach ( $gallery_settings['slide-ids'] as $attachment_id ) {
				...
				?>
					<div class="single-image <?php echo esc_attr( $col_large_desktops ); ?> <?php echo esc_attr( $col_desktops ); ?> <?php echo esc_attr( $col_tablets ); ?> <?php echo esc_attr( $col_phones ); ?>">
						<div class="vg-title"><?php echo esc_html_e( $title ); ?></div>
							<img class="img-thumbnail vid-<?php echo esc_attr( $video_gallery_id ); ?>" src="<?php echo esc_url( $thumbnail_url ); ?>" alt="<?php echo esc_html_e( $title ); ?>" data-video-id="<?php echo esc_attr( $video_type ); ?>-<?php echo esc_attr( $video_id ); ?>" alt="<?php echo esc_html_e( $title ); ?>">
						<div class="vg-desc"><?php echo esc_html_e( $description ); ?></div>
					</div>
					<?php
					$count++;
