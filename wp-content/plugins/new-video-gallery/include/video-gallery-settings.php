	...
	<div class="col-lg-12 bhoechie-tab-container">
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
			<div class="list-group">
				<a href="#" class="list-group-item active text-center">
					<span class="dashicons dashicons-format-video"></span><br/><?php esc_html_e( 'Add Video', 'new-video-gallery' ); ?>
				</a>
				<a href="#" class="list-group-item text-center">
					<span class="dashicons dashicons-admin-generic"></span><br/><?php esc_html_e( 'Config', 'new-video-gallery' ); ?>
				</a>
				<a href="#" class="list-group-item text-center">
					<span class="dashicons dashicons-controls-pause"></span><br/><?php esc_html_e( 'Auto Play Setting', 'new-video-gallery' ); ?>
				</a>
				<a href="#" class="list-group-item text-center">
					<span class="dashicons dashicons-media-code"></span><br/><?php esc_html_e( 'Custom CSS', 'new-video-gallery' ); ?>
				</a>
				<a href="#" class="list-group-item text-center">
					<span class="dashicons dashicons-cart"></span><br/><?php esc_html_e( 'Upgrade To Pro', 'new-video-gallery' ); ?>
				</a>
			</div>
		</div>
		...
		<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab">
			<div class="bhoechie-tab-content active">
				<h1><?php esc_html_e( 'ADD Video Banner', 'new-video-gallery' ); ?></h1>
				<hr>
				<div id="slider-gallery">
					<h3><span class="dashicons dashicons-editor-help"></span> Tips: <a href="https://awplife.com/how-to-get-youtube-or-vimeo-video-id/" target="_blank"><?php esc_html_e( 'How to get YouTube / Vimeo video id?', 'new-video-gallery' ); ?></a></h3>
					<h3><span class="dashicons dashicons-editor-help"></span> Tips: <a href="https://awplife.com/capture-youtube-vimeo-video-poster-like-a-pro/" target="_blank"><?php esc_html_e( 'Capture YouTube / Vimeo Video Poster Like A Pro', 'new-video-gallery' ); ?></a></h3>
					<input type="button" id="remove-all-slides" name="remove-all-slides" class="button button-large remove-all-slides" rel="" value="<?php esc_html_e( 'Delete All Banner', 'new-video-gallery' ); ?>">
					...
					if ( isset( $allimagesetting['slide-ids'] ) ) {
						...
						foreach ( $allimagesetting['slide-ids'] as $id ) {
							...
							?>
						<li class="slide">
							<img class="new-slide" src="<?php echo esc_url( $thumbnail[0] ); ?>" alt="<?php echo esc_html( get_the_title( $id ) ); ?>" style="height: 150px; width: 100%; border-radius: 8px;">
							<input type="hidden" id="slide-ids[]" name="slide-ids[]" value="<?php echo esc_html( $id ); ?>" />
							<!-- Image Title, Caption, Alt Text-->
							<select id="slide-type[]" name="slide-type[]" style="width: 100%;" value="<?php echo esc_html( $image_type ); ?>" >
								<option value="y" 
								<?php
								if ( $image_type == 'y' ) {
									echo 'selected=selected';}
								?>
								><?php esc_html_e( 'YouTube', 'new-video-gallery' ); ?></option>
								<option value="v" 
								<?php
								if ( $image_type == 'v' ) {
									echo 'selected=selected';}
								?>
								><?php esc_html_e( 'Vimeo', 'new-video-gallery' ); ?></option>
							</select>
							<input type="text" name="slide-link[]" id="slide-link[]" style="width: 100%;" placeholder="Enter YouTube / Vimeo Video ID" value="<?php echo esc_html( $image_link ); ?>">
							<input type="text" name="slide-title[]" id="slide-title[]" style="width: 100%;" placeholder="Video Title" value="<?php echo esc_html( get_the_title( $id ) ); ?>">
							<textarea name="slide-desc[]" id="slide-desc[]" placeholder="Video Description" style="height: 100px; width: 100%;"><?php echo esc_html( $attachment->post_content ); ?></textarea>
							<select id="poster-type[]" name="poster-type[]" style="width: 100%;" value="<?php echo esc_html( $poster_type ); ?>">
								...
								if ( $poster_type == 'internal' ) {
									echo 'selected';}
								?>
								><?php esc_html_e( 'Use Above Poster', 'new-video-gallery' ); ?></option>
								<option value="youtube" 
								<?php
								if ( $poster_type == 'youtube' ) {
									echo 'selected';}
								?>
								><?php esc_html_e( 'Fetch YouTube Poster', 'new-video-gallery' ); ?></option>
								</optgroup>
							</select>
			...
			<div class="bhoechie-tab-content">
				<h1><?php esc_html_e( 'Configuration', 'new-video-gallery' ); ?></h1>
				<hr>
				<!--Grid-->
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Columns & Thumbnail Settings', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Select gallery thumnails size to display into gallery', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						...
						<select id="gal_thumb_size" name="gal_thumb_size" class="selectbox_settings">
							...
							if ( $gal_thumb_size == 'thumbnail' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( 'Thumbnail – 150 × 150', 'new-video-gallery' ); ?></option>
							<option value="medium" 
							<?php
							if ( $gal_thumb_size == 'medium' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( 'Medium – 300 × 169', 'new-video-gallery' ); ?></option>
							<option value="large" 
							<?php
							if ( $gal_thumb_size == 'large' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( 'Large – 840 × 473', 'new-video-gallery' ); ?></option>
							<option value="full" 
							<?php
							if ( $gal_thumb_size == 'full' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( 'Full Size – 1280 × 720', 'new-video-gallery' ); ?></option>
						</select>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Colums On Large Desktops', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Select gallery column layout for large desktop devices', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						...
						<select id="col_large_desktops" name="col_large_desktops" class="selectbox_settings">
							...
							if ( $col_large_desktops == 'col-lg-12' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( '1 Column', 'new-video-gallery' ); ?></option>
							<option value="col-lg-6" 
							<?php
							if ( $col_large_desktops == 'col-lg-6' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( '2 Column', 'new-video-gallery' ); ?></option>
							<option value="col-lg-4" 
							<?php
							if ( $col_large_desktops == 'col-lg-4' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( '3 Column', 'new-video-gallery' ); ?></option>
							<option value="col-lg-3" 
							<?php
							if ( $col_large_desktops == 'col-lg-3' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( '4 Column', 'new-video-gallery' ); ?></option>
							<option value="col-lg-2" 
							<?php
							if ( $col_large_desktops == 'col-lg-2' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( '6 Column', 'new-video-gallery' ); ?></option>
							<option value="col-lg-1" 
							<?php
							if ( $col_large_desktops == 'col-lg-1' ) {
								echo 'selected=selected';}
							?>
							><?php esc_html_e( '12 Column', 'new-video-gallery' ); ?></option>
						</select>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Colums On Desktops', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Select gallery column layout for desktop devices', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
				...
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Colums On Tablets', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Select gallery column layout for tablet devices', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
				...
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Colums On Phones', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Select gallery column layout for phone devices', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
				...
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( ' Width ', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Set the video frame preview width. Default is 700.', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						...
						<input type="number" class="selectbox_settings" id="width" name="width" placeholder="" value="<?php echo esc_html( $width ); ?>">
					</div>
				</div>
				
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( ' Height Settings', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Set the video frame preview height. Default is 480', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						...
						<input type="number" class="selectbox_settings" id="height" name="height" placeholder="" value="<?php echo esc_html( $height ); ?>">
					</div>
				</div>
			</div>
			
			<div class="bhoechie-tab-content">
				<h1><?php esc_html_e( 'Auto play/Close Settings', 'new-video-gallery' ); ?></h1>
				<hr>
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Auto Play', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Start playback immediately once the element is clicked (true,false)', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						<p class="switch-field em_size_field">
							...
							?>
							>
							<label for="auto_play1"><?php esc_html_e( 'Yes', 'new-video-gallery' ); ?></label>
							...
							?>
							>
							<label for="auto_play2"><?php esc_html_e( 'No', 'new-video-gallery' ); ?></label>
						</p>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Auto Close', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'When video will complete than lightbox / popover automatic video is close (true,false)', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						<p class="switch-field em_size_field">
							...
							?>
							>
							<label for="auto_close1"><?php esc_html_e( 'Yes', 'new-video-gallery' ); ?></label>
							<input type="radio" class="form-control" id="auto_close2" name="auto_close" value="false" 
							<?php
							if ( $auto_close == 'false' ) {
								echo 'checked';}
							?>
							>
							<label for="auto_close2"><?php esc_html_e( 'No', 'new-video-gallery' ); ?></label>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="bhoechie-tab-content">
				<h1><?php esc_html_e( 'Extra Other Settings', 'new-video-gallery' ); ?></h1>
				<hr>
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Z index', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Set the Z-index of video frame preview page overlay. Default is 2100', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4 range-slider switch-field em_size_field">
						...
						if ( $z_index == 'default' ) {
							$z_index_custom_value = 2100; } else {
						...
						<input type="radio" class="form-control" id="z_index1" name="z_index" value="default" 
						<?php
						if ( $z_index == 'default' ) {
							echo 'checked';}
						?>
						> 
						<label for="z_index1"><?php esc_html_e( 'Default', 'new-video-gallery' ); ?></label>
						<input type="radio" class="form-control" id="z_index2" name="z_index" value="custom" 
						<?php
						if ( $z_index == 'custom' ) {
							echo 'checked';}
						?>
						>
						<label for="z_index2"><?php esc_html_e( 'Custom', 'new-video-gallery' ); ?></label>
						<br><br><br>
						<input id="z_index_custom_value" name="z_index_custom_value" class="range-slider__range" type="range" value="<?php echo esc_html( $z_index_custom_value ); ?>" min="0" max="9999" step="10" style="width: 300px !important; margin-left: 10px;">
						<span class="range-slider__value">0</span>
					</div>
				</div>
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php esc_html_e( 'Custom CSS', 'new-video-gallery' ); ?></h5>
						<p><?php esc_html_e( 'Apply own css on video gallery and dont use style tag', 'new-video-gallery' ); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						...
						?>
						<textarea name="custom_css" id="custom_css" style="width: 100%; height: 120px;" placeholder="Type direct CSS code here. Don't use <style>...</style> tag."><?php echo $custom_css; ?></textarea>
					</div>
				</div>
			</div>
			<div class="bhoechie-tab-content">
				<h1><?php esc_html_e( 'Upgrade To Pro', 'new-video-gallery' ); ?></h1>
				<hr>
				<!--Grid-->
